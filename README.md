...
本隐私政策中涉及的个人信息包括：<font face="仿宋" color=red size=15> **基本信息（包括个人姓名、生日、性别、住址、个人电话号码、电子邮箱）；<span style="color: #d9534f; font-weight: bold; background-color: #f9f2f4; padding: 2px 5px; border-radius: 3px;">个人身份信息（包括身份证号码）</span>；企业信息（企业营业执照、财务账户信息等）；<span style="color: #d9534f; font-weight: bold; background-color: #f9f2f4; padding: 2px 5px; border-radius: 3px;">个人生物识别信息（包括声纹、面部识别特征等）</span>；网络身份标识信息（包括系统账号、IP地址、邮箱地址及与前述有关的密码）；<span style="color: #d9534f; font-weight: bold; background-color: #f9f2f4; padding: 2px 5px; border-radius: 3px;">个人财产信息（包括交易和消费记录、银行账号）</span>；<span style="color: #d9534f; font-weight: bold; background-color: #f9f2f4; padding: 2px 5px; border-radius: 3px;">通讯录</span>；<span style="color: #d9534f; font-weight: bold; background-color: #f9f2f4; padding: 2px 5px; border-radius: 3px;">个人上网记录（包括网站浏览记录、软件使用记录、点击记录）</span>；个人常用设备信息（包括硬件型号、设备MAC地址、操作系统类型、软件列表唯一设备识别码（如IMEI/ANDROID ID/IDFA/OPENUDID/GUID、SIM卡IMSI信息等在内的描述个人常用设备基本情况的信息）；<span style="color: #d9534f; font-weight: bold; background-color: #f9f2f4; padding: 2px 5px; border-radius: 3px;">个人位置信息</span>**。</font>
...
<div style="background-color: #f8f9fa; border-left: 4px solid #d9534f; padding: 10px 15px; margin: 10px 0;"> <p style="font-weight: bold; color: #d9534f;">应用本身收集的信息：</p> <p>我们的应用会收集 <span style="color: #d9534f; font-weight: bold; background-color: #f9f2f4; padding: 2px 5px; border-radius: 3px;">ANDROID ID</span> 用于设备识别和服务优化。</p> </div><div style="background-color: #f8f9fa; border-left: 4px solid #d9534f; padding: 10px 15px; margin: 10px 0;"> <p style="font-weight: bold; color: #d9534f;">推送SDK：</p> <p>使用目的：为了及时向用户提供预约工单、系统更新等服务通知。</p> <p>使用方式：使用了消息PUSHSDK，如您使用小米、魅族、华为、OPPO、VIVO、苹果手机，我们接入的上述手机厂商PushSDK，这些SDK需要获取您的手机终端唯一标识信息，并可能会收集您的手机型号、系统类型、系统版本、设备屏幕尺寸参数用于实现APP推送服务。</p> <p>收集个人数据类型：手机型号、系统类型、系统版本、设备屏幕尺寸参数。</p> <p>第三方SDK隐私政策：https://www.easemob.com/protocol</p> </div><div style="background-color: #f8f9fa; border-left: 4px solid #d9534f; padding: 10px 15px; margin: 10px 0;"> <p style="font-weight: bold; color: #d9534f;">腾讯BuglySDK：</p> <p>使用目的：监控本客户端崩溃、页面异常问题</p> <p>使用方式：我们收集数据是根据您与我们的互动和您所做出的选择，包括您的隐私设置以及您使用的产品和功能。</p> <p>收集个人数据类型：我们收集的数据可能包括SDK/API/JS代码版本、浏览器、互联网服务提供商、IP地址、平台、时间戳、应用标识符、应用程序版本、应用分发渠道、独立设备标识符、iOS广告标识符（IDFA)、安卓广告主标识符、网卡（MAC）地址、国际移动设备识别码（IMEI）、设备型号、终端制造厂商、终端设备操作系统版本、会话启动/停止时间、语言所在地、时区和网络状态（WiFi等）、硬盘、CPU和电池使用情况等。</p> <p>第三方SDK隐私政策：http://bugly.qq.com/v2/contract</p> </div><div style="background-color: #f8f9fa; border-left: 4px solid #d9534f; padding: 10px 15px; margin: 10px 0;"> <p style="font-weight: bold; color: #d9534f;">百度地图SDK：</p> <p>使用目的：为用户提供定位功能和服务</p> <p>使用方式：为了提升定位服务准确性和成功率，为特定连续定位场景提供持续定位服务。</p> <p>收集个人数据类型：设备信息【包括设备标识信息（Android ID、IDFA、IDFV）、系统信息（操作系统版本、设备品牌及型号、设备配置）和应用信息（应用名）】、位置信息【可能包括经纬度、GNSS信息、WiFi网关地址、WiFi MAC地址、WiFi信号强度、WiFi状态、WiFi参数、WiFi列表、基站ID数据信息、运营商信息、设备信号强度信息、IP地址、蓝牙信息和传感器信息（加速度，陀螺仪、方向、压力、旋转矢量、光照、磁力计）】、网络类型【如移动网络、WiFi网络】。</p> <p>第三方SDK隐私政策：https://lbsyun.baidu.com/index.php?title=openprivacy</p> </div><div style="background-color: #f8f9fa; border-left: 4px solid #d9534f; padding: 10px 15px; margin: 10px 0;"> <p style="font-weight: bold; color: #d9534f;">声网SDK：</p> <p>使用目的：为用户提供聊天工具</p> <p>使用方式：服务优化和开发。例如，我们会根据环信通讯云系统响应您的需求时产生的信息，优化我们的服务。</p> <p>收集个人数据类型：设备信息（设备型号、操作系统、CPU类型），应用信息（宿主应用包名，版本号）</p> <p>第三方SDK隐私政策：https://www.easemob.com/protocol</p> </div><div style="background-color: #f8f9fa; border-left: 4px solid #d9534f; padding: 10px 15px; margin: 10px 0;"> <p style="font-weight: bold; color: #d9534f;">腾讯浏览服务SDK：</p> <p>使用目的：为用户提供H5页面浏览</p> <p>使用方式：按用户的应用的具体功能场景，在用户触发具体功能场景时调用SDK的相应功能、调用相应权限或处理终端用户的个人信息，未到具体业务或功能场景时不应调用相应权限。</p> <p>收集个人数据类型：设备信息（设备型号、操作系统、CPU类型），应用信息（宿主应用包名，版本号）</p> <p>第三方SDK隐私政策： https://rule.tencent.com/rule/preview/1c4e2b4b-d0f6-4a75-a5c6-1cfce00a390d</p> </div><div style="background-color: #f8f9fa; border-left: 4px solid #d9534f; padding: 10px 15px; margin: 10px 0;"> <p style="font-weight: bold; color: #d9534f;">Tencent X5 (SMTT) SDK：</p> <p>使用目的：网页渲染</p> <p>使用方式：按用户的应用的具体功能场景，在用户触发具体功能场景时调用SDK的相应功能、调用相应权限或处理终端用户的个人信息，未到具体业务或功能场景时不应调用相应权限。</p> <p>收集个人数据类型：<span style="color: #d9534f; font-weight: bold; background-color: #f9f2f4; padding: 2px 5px; border-radius: 3px;">设备ID, IMSI, ANDROID ID</span></p> <p>第三方SDK隐私政策： https://x5.tencent.com/docs/privacy.html</p> </div><div style="background-color: #f8f9fa; border-left: 4px solid #d9534f; padding: 10px 15px; margin: 10px 0;"> <p style="font-weight: bold; color: #d9534f;">Bugly Android SDK：</p> <p>使用目的：异常上报</p> <p>使用方式：程序报错信息上报，方便开发者定位异常问题，提升系统的稳定性。</p> <p>收集个人数据类型：<span style="color: #d9534f; font-weight: bold; background-color: #f9f2f4; padding: 2px 5px; border-radius: 3px;">设备ID, ICCID, IMSI, MAC地址, ANDROID ID</span></p> <p>第三方SDK隐私政策： https://static.bugly.qq.com/bugly-sdk-privacy-statement.pdf</p> </div>
